module.exports = (function() {
    ...
    var slide = {
        "element": "shoji:entity"
        ,"self": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/"
        ,"specification": "***REMOVED***/api/specifications/user_datasets/"
        ,"description": "User view of a dataset"
        ,"body": {
            "archived": false
            ,"user_id": "00002"
            // comma after null for browserify
            ,"row_labels_variable": null, "weight": "***REMOVED***/api/datasets/0324e4c77d664234b243b19b13132a95/variables/weight/"
            ...
            ,"name": "ECON_Small.sav"}
            ,"urls": {"filters_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/filters/"
            ,"role_url": "***REMOVED***/api/roles/datasets/528725b93bf09b3dbc59d1e5/"
            ,"grid_view_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/grid_view/"
            ,"dataset_url": "***REMOVED***/api/datasets/0324e4c77d664234b243b19b13132a95/"
            ,"array_xtab_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/array_xtab/"
            ,"sources_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/sources/"
            ,"xtab_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/xtab/"
            ,"decks_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/decks/"
            ,"apply_analysis_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/apply_analysis/"
            ,"histogram_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/histogram/"
            ,"share_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/share/"
            ,"summary_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/summary/"
            ,"discarded_variables_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/discarded_variables/"
            ,"users_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/users/"
            ,"user_url": "***REMOVED***/api/users***REMOVED***", "weight_variables_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/weight_variables/"
            ,"applied_exclusion_filters_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/applied_exclusion_filters/"
            ,"rows_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/rows/"
            ,"tags_list_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/tags_list/"
            ,"variables_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/variables/"
            ,"exclusion_filters_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/exclusion_filters/"
            ,"bind_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/bind/"
            ,"analyze_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/analyze/"
            ,"applied_filters_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/applied_filters/"
        }
    }
    var slideEntity = {
        "element": "shoji:entity"
        ,"self": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/decks/768bfc526f6e49f9acfda15c8a4456de/slides/80a3c6031b2b492c870938470ccccb60/"
        ...
        ,"urls": {
            "analyses_url": "***REMOVED***/api/users***REMOVED***datasets/47b0818d6a6a4d25b41006a885cd0a56/decks/768bfc526f6e49f9acfda15c8a4456de/slides/80a3c6031b2b492c870938470ccccb60/analyses/"
        }
    }
    */
    // ***REMOVED***/api/users/139/datasets/622/decks/cf6/slides/ef1/
    var slidesForDataset = {"element": "shoji:entity", "self": "***REMOVED***/api/users/139/datasets/622/decks/cf6/slides/ef1/", "description": "Returns the detail information for a given slide", "body": {"deck_id": "cf6b7996e6944a57abaa50322f8034b4", "subtitle": "BOW_Number", "id": "ef15d2637481473e8f011d656ea8cf78", "title": "Coordinate Type"}, "urls": {"analyses_url": "***REMOVED***/api/users/139/datasets/622/decks/cf6/slides/ef1/analyses/"}}
    // ***REMOVED***/api/users/139/datasets/622/decks/cf6/slides/ef1/analyses/
    var analysesForDataset = {"element": "shoji:catalog", "self": "***REMOVED***/api/users/139/datasets/622/decks/cf6/slides/ef1/analyses/", "specification": "***REMOVED***/api/specifications/analyses/", "description": "List of all analyses inside this slide", "entities": ["***REMOVED***/api/users/139/datasets/622/decks/cf6/slides/ef1/analyses/e3b/"], "index": {"***REMOVED***/api/users/139/datasets/622/decks/cf6/slides/ef1/analyses/e3b/": {}}}
    // ***REMOVED***/api/users/139/datasets/622/decks/cf6/slides/ef1/analyses/e3b/
    var anAnalysisForDataset = {"element": "shoji:entity", "self": "***REMOVED***/api/users/139/datasets/622/decks/cf6/slides/ef1/analyses/e3b/", "description": "Data to build a given analyses", "body": {"query_environment": {"weight_variable": null, "applied_filters": []}, "query_url": "***REMOVED***/api/datasets/2648f5e4455642518bb9ba0e2d26e2be/xtab/?variables_urls=https%3A%2F%2F***REMOVED***%2Fapi%2Fdatasets%2F2648f5e4455642518bb9ba0e2d26e2be%2Fvariables%2FcoordinateType%2F%2Chttps%3A%2F%2F***REMOVED***%2Fapi%2Fdatasets%2F2648f5e4455642518bb9ba0e2d26e2be%2Fvariables%2Fbow_Number%2F", "id": "e3b78b71fbd54a9ab97c6e2ef6cd28b5", "query": {
        dimensions:[
